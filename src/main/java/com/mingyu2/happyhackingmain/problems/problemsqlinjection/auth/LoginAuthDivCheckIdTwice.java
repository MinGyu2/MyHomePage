...
public final class LoginAuthDivCheckIdTwice implements LoginAuth{
    private String tableName = "members";
    private Connection conn;
    private String dbDriver = "", dbURL="", dbUser="", dbPWD="";
    private String sqlQuery = "";
    public LoginAuthDivCheckIdTwice(ServletContext context){
    ...
    public String auth(String username, String pwd) { // 비번이 일치하면 username 을 리턴한다.
        ...
        try {
            ...
            query
                ...
                .append(tableName)
                .append(" where id='").append(username)
                .append("' and id='").append(username).append("'");
